...
- 🔹 **Other**: REST APIs, GraphQL, WebAssembly, PostgreSQL
...
- Creating high performance applications in Rust cod
...
- **Performance-first** — Build fast, feel fast.
- **Type safety matters** — Catch bugs before they ship.
- **Simple > Clever** — Clarity in code beats unnecessary complexity.
- **Consistency wins** — Small improvements daily compound over time.

---

> *“Crafting code that speaks for itself — clean, expressive, and production-ready.”*
